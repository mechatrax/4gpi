...
* ### 4gpi-bullseye-lite-armhf-20220805
  20220805 の記載があるものは本リリースの OS イメージがインストールされています。  
  詳細は、[4gpi-bullseye-lite-armhf-20220805.md](./4gpi-bullseye-lite-armhf-20220805.md) を参照してください。
